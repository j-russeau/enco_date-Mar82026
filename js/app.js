...
no.addEventListener("click", () => {
  if (count == 2) {
    ...
    gif.style.width = "270px"; 
    text.innerHTML = "1 Thessalonians 5:11 <br> Therefore encourage one another... 😔";
    yes.style.height = "70%";
    yes.style.width = "70%";
    no.style.width = "20%";
    count++;
    ...
    gif.style.width = "270px"; 
    text.innerHTML = "Okay iiyak na ko 😭";
    yes.style.height = "80%";
    yes.style.width = "80%";
    ...
    gif.style.width = "330px"; 
    text.innerHTML = "Plsplsplspls <br> 🥺🥺🥺";
    yes.style.height = "90%";
    yes.style.width = "96%";
...
yes.addEventListener("click", () => {
  ...
  gif.style.width = "480px"; 
  text.innerHTML = "HAHA I KNEW IT !! <br> See u sa Sunday! 😁😁";
  yes.innerHTML = '<a href="https://youtu.be/xMHJGd3wwZk/">Gift for you!</a>';// inside the " " put your social media profile link
  yes.style.height = "90%";
  yes.style.width = "96%";
  no.style.display = "none";
  setTimeout(() => {
